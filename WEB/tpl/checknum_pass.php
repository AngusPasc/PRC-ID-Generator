...
?>
		<p>根据计算，您输入的身份证号码：<?php echo $inputIDNum; ?>是一个有效的身份证号码。</p>
		<div>
			该身份证发证所在地：<?php echo $placesArr[$placeId];?>。<br />
			该身份证的持有人出生日期：<?php echo $birthDate[0];?>年<?php echo $birthDate[1];?>月<?php echo $birthDate[2];?>日。<br />
